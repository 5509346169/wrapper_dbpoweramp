...
This document describes how dBpoweramp Wrapper is structured internally. It is aimed at developers who want to understand, extend, or debug the tool. End users should start with [README](https://github.com/5509346169/wrapper_dbpoweramp/blob/main/README.md) and the [landing page](/).
