...
For files still ambiguous after Tiers 1 and 2, the wrapper reads the audio metadata using mutagen to determine the actual codec:
...
**Note:** This introduces additional quality loss. Only use if you understand the implications.
...
**Note:** This is mutually exclusive with `--lossy-action`.
